  ...
  render() {
    ...
    return (
      <div className="explorer">
        ...
        <p className="DefaultParagraph-1">Search <a href="http://export.gov/ecr/eg_main_023148.asp">the screening lists</a> at one time by filling in the search boxes below.  If you get too many results, try including more information to the additional fields.  If you get too few results, try searching one field at a time.</p>
